	...
	$(document).ready(function(){
		...
		function dsiplayRecipePost(data){
			...
			for (var i = 0; i < homeList.length; i++) {
				...
				homeListHtmlDOM+='<div idata="'+homeList[i]['id']+'" class="vip-enjoy"><div class="vip-video"><video src="movie.ogg" controls="controls">您的浏览器不支持 video 标签。</video></div><div class="vip-content"><div class="vip-title"><a href="introduction.php#'+homeList[i]['id']+'">'+homeList[i]["title"]+'</a></div><div class="vip-post"><a href="introduction.php#'+homeList[i]["id"]+'">'+homeList[i]["paper"]+'</a></div><div class="vip-menu"><ul><li><span class="glyphicon glyphicon-eye-open"></span> '+homeList[i]["browse_num"]+'</li><li type="1" onclick="addToReadingList(this);" articleid='+homeList[i]['id']+'><span class="glyphicon glyphicon-heart-empty"></span></li><li><span class="glyphicon glyphicon-link"></span></li></ul></div><div class="teacher-brand"><img src="'+homeList[i]['arrange_image_url']+'"></div></div>'+isVipHTML+'</div>';
			};
